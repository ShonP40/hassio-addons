...
This addon allows creating an access point **with an optional DHCP server**, for your IoT devices using the internal WiFi or an external USB WiFi dongle from brands like **Ralink & Atheros**.
